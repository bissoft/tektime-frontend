        ...
        <div className="row justify-content-center">
          {isLoading ? (
            ...
            <>
              ...
              {action?.participant?.meeting?.plan_d_actions?.filter(item => item.status === "Finished").length > 0 ?
                (
                              ...
                              <div className="cardbody">
                                ...
                                <div className="row py-4 pb-5 text-body-dark px-3">
                                  ...
                                  <div className="col-md-3 text-center obj1">
                                    <h6>{action.participant.first_name} {action.participant.last_name}</h6>
                                  </div>
                                  <div className="col-md-2 text-center obj1">
                                    <h6>{item.action}</h6>
                                  </div>
                  ...
                  <>
                    <NoContent
                      title={`Finished Action of ${action.participant.first_name} ${action.participant.last_name}`}
                    />
                  </>
                )}
            </>
