      ...
      <div className="container-fluid px-3">
        <div className="row justify-content-center">
          {isLoading ? (
            ...
            <>
              {meetings.length === 0 ? (
                <NoContent title="InProgress Actions" />
              ) : (
                <>
                  {meetings
                    ?.filter(
                      (meeting) =>
                        ...
                        meeting.participants.some(
                          (participant) =>
                            participant.inProgress_plandactions_count > 0
                        )
                    )
                    .map((meeting, index) => (
                      <>
                            ...
                            <div className="card-body">
                              <div className="cardbody">
                                ...
                                {meeting.participants
                                  .filter(
                                    (participant) =>
                                      participant.inProgress_plandactions_count >
                                      0
                                  )
                                  .map((item, index) => (
                                    <>
                                      ...
                                      >
                                        ...
                                        <div className="col-md-2 text-center obj1">
                                          <h6>
                                            ...
                                            {`${item.finished_plandactions_count}/${item.total_plandactions_count}`}
                                          </h6>
                                        </div>
                                        <div className="col-md-2 text-center obj1">
                                          <h6>{item.post}</h6>
                  ...
                  ) && <NoContent title="InProgress PlanDAction" />}
                </>
              )}
            </>
          )}
